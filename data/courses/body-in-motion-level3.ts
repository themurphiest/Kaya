...
export const level3Groups: Group[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        brief: "The primary hip flexor stretch in yoga — directly releases the iliopsoas tightness that drives anterior pelvic tilt.",
        mnemonic: "Anjaneya = the son of Anjana. Think of Hanuman's heroic lunge forward — the back knee down, the front knee bent, the chest lifted. A warrior's reach through the hip.",
        bodyMap: undefined,
        tabs: [
          {
            label: "The Pose",
            content: "Anjaneyasana places the iliopsoas of the back leg in a lengthened position — the hip is extended, which stretches the hip flexors. To deepen the stretch, the pelvis must be in a neutral or slightly posteriorly tilted position — if the lower back arches excessively (anterior tilt), the stretch is lost and lumbar compression increases. This is why teachers cue \"tuck the tailbone slightly\" in low lunge — it's not arbitrary; it's the action that actually brings the hip flexor under tension. A 30-second hold in each position after vigorous activity is sufficient for acute flexibility gains; longer holds (2-5 minutes) in a yin or restorative context stimulate deeper fascial change.",
          },
          {
            label: "How to Enter",
            content: "From tabletop or downward dog, step the right foot between the hands. Lower the left knee to the mat (padding under the knee if needed). Square the hips forward. Inhale and lift the torso upright, arms reaching overhead. Gently draw the tailbone down and forward — this is the key action that actually stretches the hip flexor. Breathe into the front of the left hip. Hold 5-8 breaths. Switch sides.",
          },
          {
            label: "Modifications",
            content: "Keep hands on the floor (on blocks) for a less intense version. Elevate the back knee (off the floor) for greater hip flexor intensity. Add a backbend (arms back, chest lifting) to combine hip flexor stretch with thoracic extension.",
          },
        ],
      },
      {
    ...
    cards: [
      {
        ...
        brief: "A spinal extension pose that counters thoracic kyphosis, opens the chest, and strengthens the posterior chain — the antidote to desk posture.",
        mnemonic: "BHUJAN-GA = the COILING serpent rising. A cobra rises from the ground by using the muscles of its back — not by pushing with the arms. Feel the difference.",
        bodyMap: undefined,
        tabs: [
          {
            label: "The Pose",
            content: "Bhujangasana directly addresses Upper Crossed Syndrome: it opens the pectorals and anterior shoulders (tight in UCS), strengthens the erector spinae and thoracic extensors (weak in UCS), and creates space in the anterior chest. The key distinction between a therapeutic and non-therapeutic cobra is whether the extension comes from the back muscles or from pushing through the arms. Using the arms to push the chest up bypasses the spinal extensors entirely — which defeats the purpose. \"Legs of the cobra\" — using the thoracic extensors to lift — is the clinical action that counteracts the rounded-back pattern.",
          },
          {
            label: "How to Enter",
            content: "Lie face down, forehead on the mat, legs hip-width. Place hands under the shoulders. Inhale: without pushing through the hands, use the back muscles to lift the chest. The hands may barely leave the mat (low cobra) or provide gentle support (medium cobra). Keep the elbows close to the body. Lengthen the neck — don't compress the back of the skull into the neck. Hold 3-5 breaths. Lower on the exhale.",
          },
          {
            label: "Modifications",
            content: "Baby cobra (very low lift, hands barely touching the mat) is most therapeutic for back pain. For those with healthy spines, progress to a fuller backbend by straightening the arms more. Avoid in acute lower back pain or disc herniation.",
          },
        ],
      },
      {
        ...
        brief: "A supported backbend on the forearms — gentler than full cobra, sustained longer, ideal for reversing chronic thoracic kyphosis.",
        mnemonic: "SA-LAMBA = with support. The sphinx is supported by its elbows — ancient, patient, enduring. This pose asks for the same quality: sustained, passive, supported opening.",
        bodyMap: undefined,
        tabs: [
          {
            label: "The Pose",
            content: "Sphinx is the \"baby\" of backbends — accessible to almost everyone, including people with acute lower back issues. The forearm support reduces lumbar compression while still creating thoracic extension. Held for longer periods (2-5 minutes in a yin context), sphinx creates sustained longitudinal traction through the anterior spine — the anterior longitudinal ligament and hip flexors lengthen passively. It is a direct antidote to the \"tech neck\" and thoracic kyphosis of Upper Crossed Syndrome, held passively so the muscles learn to relax rather than actively extend.",
          },
          {
            label: "How to Enter",
            content: "Lie face down. Bring the elbows under the shoulders, forearms parallel. Lift the chest, allowing the lumbar spine to gently extend. Relax the buttocks and legs — this is a passive pose. Let gravity do the work. The head is in a neutral position. Hold 2-5 minutes in yin practice, or 5-8 breaths in a more active practice.",
          },
          {
            label: "Modifications",
            content: "Place a folded blanket under the forearms for comfort. Move the elbows further forward (reducing the angle) to decrease intensity. For a deeper version, straighten the arms (Bhujangasana/Cobra).",
          },
        ],
      },
      {
    ...
    cards: [
      {
        ...
        brief: "The foundational core stabilization pose — the entire body as one rigid unit, maintained by coordinated deep core activation, not muscular bracing.",
        mnemonic: "PHALAKA = a flat plank of wood. The body should be as rigid and flat as a plank — not sagging in the middle, not lifting at the hips. A plank is rigid because of its internal structure, not its surface.",
        bodyMap: undefined,
        tabs: [
          {
            label: "The Pose",
            content: "Plank is the most practical core stabilization exercise in yoga. It requires the TVA, multifidus, diaphragm, and pelvic floor to co-activate to maintain a neutral spine against gravity — exactly the clinical definition of core stability. The common errors — hips too high (avoiding the work), hips sagging (core failing), breath held (destroying the core canister) — all reveal instability rather than weakness. Plank should be practiced with continuous, diaphragmatic breathing: if you cannot breathe normally in plank, the load is too high. Stuart McGill's research recommends this type of isometric stabilization over spinal-flexion exercises (crunches) as the primary core training modality.",
          },
          {
            label: "How to Enter",
            content: "From downward dog or tabletop, shift forward to stack shoulders over wrists. Body forms a straight line from crown to heels. Engage the TVA (draw the navel gently toward the spine without holding the breath). Press the floor away with straight arms. Keep the neck long — don't drop the head or look forward. Breathe normally. Hold for time (start with 20-30 seconds) rather than to failure.",
          },
          {
            label: "Modifications",
            content: "Knees-down plank reduces the load significantly and is appropriate for beginners or those with lower back issues. Forearm plank (Phalakasana on the forearms) removes wrist load. To progress: lift one foot slightly while maintaining level hips.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        brief: "A standing twist that combines thoracic rotation, hip hinge, and hamstring lengthening — restoring mobility across multiple kinetic chain joints simultaneously.",
        mnemonic: "PARI-VRTTA = PARTly reVOLVED. You revolve the triangle — taking the most stable standing pose and adding the most missing movement: rotation.",
        bodyMap: undefined,
        tabs: [
          {
            label: "The Pose",
            content: "Revolved triangle is one of the most demanding standing poses because it requires thoracic rotation (often severely restricted), hip extension (testing the hip flexors of the back leg), and hamstring length (front leg) — all simultaneously. The thoracic rotation demand is critical: if the thoracic spine cannot rotate adequately, the twist will come from the lumbar spine (which should be stable, not rotational) — a perfect demonstration of the kinetic chain compensation principle. The pose teaches the practitioner to discriminate between lumbar and thoracic movement.",
          },
          {
            label: "How to Enter",
            content: "From standing, step the left foot back 3-4 feet. Front foot points forward, back foot turns 45 degrees. Square the hips forward as much as possible. Inhale: extend the spine long. Exhale: hinge forward from the hips (not the waist), placing the left hand to the outside of the right foot (or a block). Inhale: rotate the right arm toward the ceiling, opening the chest. The rotation should come from the thoracic spine — feel the mid-back twisting, not the lower back. Hold 5-8 breaths. Switch sides.",
          },
          {
            label: "Modifications",
            content: "Use a block under the lower hand to reduce hamstring demand. Keep the twist less extreme if thoracic rotation is limited — go to where the thoracic spine actually rotates, not where the lumbar spine would compensate.",
          },
        ],
      },
      {
