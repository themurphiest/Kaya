...
export const movementConcepts: Course = {
  ...
  slug: "movement-concepts",
  title: "Movement Concepts",
  subtitle: "How the pieces work together",
  description: "The patterns, syndromes, and principles that explain why your body moves — and breaks down — the way it does.",
  status: "available",
  accent: "#C4875A",
  groups: [
    {
