...
/* ── Polygon data adapted from react-body-highlighter (MIT) ── */
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <svg
        ...
        height="100%"
        viewBox="0 0 100 220"
        style={{ maxWidth: 220, maxHeight: 480 }}
      >
        {data.map((group) =>
